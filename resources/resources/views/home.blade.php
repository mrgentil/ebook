                            ...
                            <div class="widget-content">
                                ...
                                <div class="promo-text" style="font-size: 45px;line-height:40px;">
                                    <div class="wow fadeInUpBig" data-wow-duration="0.4s" data-wow-delay="0.4s" style="color: #FFF !important">
                                        La Bibliothèque numérique de la Sagesse congolaise !
                                    </div>
                                </div>
                            </div>
                        </div>
                                                        ...
                                                        <header>
                                                            ...
                                                            <h4 class="entry-title">
                                                                <a href="{{Storage::url($book->file)}}">
                                                                    <span style="display:block;font-size: 14px;font-family:'Azonix Regular';
                                                                    color:#FAD01E"><i class="fa fa-download"></i> Download</span>
                                                                </a>
                                                            </h4>
                                                        </header>
                                                        ...
                                                        <div class="entry-content">
                                                            <header>
                                                                ...
                                                                <h4 class="entry-title">
                                                                    <a href="">
                                                                    <span style="display:block;font-size: 14px;font-family:'Azonix Regular';
                                                                    color:#FAD01E"><i class="fa fa-download"></i> Acheter</span>
                                                                    </a>
                                                                </h4>
                                                            </header>
                                                            <p>{!!  str_limit($book->description, 100) !!} </p>
